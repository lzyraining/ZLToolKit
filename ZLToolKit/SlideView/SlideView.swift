...
public class SlideView: UIView {
    ...
    lazy var pageControl: UICollectionView = {
        ...
        collectionView.register(SlideViewPageControlCell.self, forCellWithReuseIdentifier: SlideView.pageControlCellId)
...
extension SlideView: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SlideView.pageControlCellId, for: indexPath) as? SlideViewPageControlCell {
